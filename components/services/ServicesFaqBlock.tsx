...
const DEFAULT_FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer: "Nexterse LLC provides five core service lines: AI and agentic development, IoT and AIoT development, custom and enterprise software, legacy modernization, and MVP development. The company has worked across 12+ industries over 14 years, with headquarters in Boston and a development center in Warsaw. Published work includes enterprise software for Toyota and projects for Beiersdorf.",
  },
  {
