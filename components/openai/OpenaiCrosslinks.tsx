...
const COLS = [
  {
    ...
    links: [
      ...
      { text: "Custom AI agents development", href: "/services/ai-software-development" },
      { text: "Enterprise RAG development", href: "/services/rag-development" },
      { text: "Custom LLM development", href: "/services/llm-development" },
      { text: "GenAI development services", href: "/services/genai-development" },
...
export default function OpenaiCrosslinks() {
  return (
