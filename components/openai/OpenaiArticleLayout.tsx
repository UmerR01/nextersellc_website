...
export default function OpenaiArticleLayout({ children }: { children: ReactNode }) {
  const [activeId, setActiveId] = useState("oai-services");
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      let current = sections[0]?.id ?? "oai-services";
  ...
  return (
    <div className={styles.articleContent}>
      ...
      <aside className={styles.navigation} aria-label="OpenAI development page contents">
