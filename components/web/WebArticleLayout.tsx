...
import styles from "./WebArticleLayout.module.css";
...
export default function WebArticleLayout({ children }: { children: ReactNode }) {
  const [activeId, setActiveId] = useState("web-benefits");
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      let current = sections[0]?.id ?? "web-benefits";
      sections.forEach((el) => {
  ...
  return (
    <div className={styles.articleContent}>
      ...
      <aside className={styles.navigation} aria-label="Web page contents">
