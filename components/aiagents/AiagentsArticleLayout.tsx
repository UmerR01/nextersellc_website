...
export default function AiagentsArticleLayout({ children }: { children: ReactNode }) {
  const [activeId, setActiveId] = useState("ai-services");
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      let current = sections[0]?.id ?? "ai-services";
  ...
  return (
    <div className={styles.articleContent}>
      ...
      <aside className={styles.navigation} aria-label="AI agents development page contents">
