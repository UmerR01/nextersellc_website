...
const RISKS = [
  ...
  },
  {
    ...
    body: "Some organizations hesitate â€” worried about security, ROI, or readiness. This leads to years of delay. Meanwhile, competitors are already using AI to automate tedious tasks, accelerate product development, and analyze business data in real time. If you wait too long, you lose efficiency and fall behind as AI becomes the industry standard.",
    how: "We take a practical approach. Our consulting process starts by identifying high-impact opportunities that deliver real value fast â€” no need for a massive overhaul on day one. We help you move ahead with AI safely, smartly, and at the right pace.",
  },
];
    ...
    <section className={styles.section}>
      <div className="container">
        ...
        <div className={styles.ctaBanner}>
          ...
          <a href="#get-modal-popup" className={`btn btn-accent ${styles.ctaBtn}`}>Book a call</a>
        </div>
      </div>
    </section>
  );
