...
import styles from "./AdtechArticleLayout.module.css";
...
export default function AdtechArticleLayout({ children }: { children: ReactNode }) {
  const [activeId, setActiveId] = useState("adt-solutions");
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      let current = sections[0]?.id ?? "adt-solutions";
      sections.forEach((el) => {
  ...
  return (
    <div className={styles.articleContent}>
      ...
      <aside className={styles.navigation} aria-label="Adtech page contents">
