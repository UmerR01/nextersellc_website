  ...
  body: [
    ...
    { type: "heading", level: 2, id: "h-how-we-approach-it-at-sumatosoft", text: "How we approach it at SumatoSoft" },
    {
      ...
      text: [
        ...
        t(" shows most AI stalls on data and integration foundations, not models. That's 350+ products over 14+ years across 25+ countries, ISO 27001- and ISO 9001-certified, with a 98% satisfaction rate. Have an aging system you want to make smarter without switching it off? "),
        b("Talk to us"),
