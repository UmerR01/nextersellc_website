...
export default function BigDataArticleLayout({ children }: { children: ReactNode }) {
  const [activeId, setActiveId] = useState("bd-services");
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      let current = sections[0]?.id ?? "bd-services";
  ...
  return (
    <div className={styles.articleContent}>
      ...
      <aside className={styles.navigation} aria-label="Big Data development page contents">
