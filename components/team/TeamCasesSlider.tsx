...
const CASES: CaseItem[] = [
  ...
  },
  {
    ...
    desc: "An AIoT predictive maintenance system that reduced equipment downtime by 62% and cut unplanned maintenance costs by 45% for a European manufacturing enterprise.",
